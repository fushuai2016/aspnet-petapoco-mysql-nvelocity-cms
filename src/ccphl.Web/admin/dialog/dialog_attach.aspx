<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dialog_attach.aspx.cs" Inherits="ccphl.Web.admin.dialog.dialog_attach" %>
...
<script type="text/javascript">
    ...
    //页面加载完成执行
    $(function () {
        $(".upload-attach").InitSWFUpload({ filesize: "20480", sendurl: "../../tools/upload_ajax.ashx", flashurl: "../../scripts/swfupload/swfupload.swf",siteid:<%=this.siteid %>,thumbnail:false,  filetypes: "*.jpg;*.jpge;*.png;*.gif;*.rar;*.zip;*.doc;*.xls;*.ppt;*.docx;*.xlsx;*.pptx;" });
