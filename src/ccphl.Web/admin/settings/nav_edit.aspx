<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="nav_edit.aspx.cs" Inherits="ccphl.Web.admin.settings.nav_edit" ValidateRequest="false" %>
...
<div class="tab-content">
  ...
  <dl>
    <dt>导航图标样式</dt>
    <dd><asp:TextBox ID="txtIcon" runat="server" CssClass="input normal" datatype="*0-100" sucmsg=" "></asp:TextBox> <span class="Validform_checktip">导航图标样式，根栏目填写</span></dd>
  </dl>
  <dl>
    <dt>链接地址</dt>
    <dd>
