...
namespace ccphl.Web.admin.settings
{
    public partial class nav_list : Web.UI.ManagePage
    {
        ...
        private void RptBind()
        {
            ...
            List<system_module> list = GetModelTreeList(0);
            //XmlConfig<system_module> xc = new XmlConfig<system_module>();
            //xc.saveListConifg(list, HttpContext.Current.Server.MapPath("~/xmlconfig/module.config"));
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < rptList.Items.Count; i++)
            {
                ...
                db.UpdateField<system_module>(id, "OrderBy", sortId);
            }
