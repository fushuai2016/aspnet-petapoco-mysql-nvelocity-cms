<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="center.aspx.cs" Inherits="ccphl.Web.admin.center" %>
...
<div class="nlist-2">
  ...
  <ul>
    ...
    <li>公司名称：<%=siteConfig.SiteName %></li>
    <li>网站域名：<%=siteConfig.DomainName %></li>
    <li>安装目录：<%=siteConfig.DomainNames %></li>
    <li>网站管理目录：<%=siteConfig.ManagePath %></li>
    <li>附件上传目录：<%=siteConfig.ManagePath %></li>
