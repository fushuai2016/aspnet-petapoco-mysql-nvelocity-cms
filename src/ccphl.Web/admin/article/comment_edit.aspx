<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="comment_edit.aspx.cs" Inherits="ccphl.Web.admin.article.comment_edit" ValidateRequest="false" %>
...
<!--导航栏-->
<div class="location">
  <a href="<%=ListName %>?siteid=<%=model.SiteID %>&channelid=<%=model.ChannelID %>" class="back"><i></i><span>返回列表页</span></a>
