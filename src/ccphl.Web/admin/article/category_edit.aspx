<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="category_edit.aspx.cs" Inherits="ccphl.Web.admin.article.category_edit" ValidateRequest="false" EnableEventValidation="false"%>
  ...
  <dl>
    ...
    <dd>
      <div class="rule-single-select">
        <asp:DropDownList id="ddlSiteId" runat="server" datatype="*" AutoPostBack="True" onselectedindexchanged="ddlSiteId_SelectedIndexChanged"></asp:DropDownList>
      </div>
      <span class="Validform_checktip">*选择栏目所属站点</span>
    </dd>
  </dl>
  <dl>
    <dt>所属频道</dt>
    <dd>
      <div class="rule-single-select">
        <asp:DropDownList id="ddlChannelId" runat="server" datatype="*" AutoPostBack="True" onselectedindexchanged="ddlChannelId_SelectedIndexChanged"></asp:DropDownList>
      </div>
      <span class="Validform_checktip">*选择栏目所属频道</span>
    </dd>
  </dl>
  <dl>
    <dt>所属父栏目</dt>
