...
namespace ccphl.Web.admin.ccphl
{
    ...
    {
        //页面名称
        public const string Name = "为民服务站用户";
        //列表页面名称
        public const string ListName = "user_list.aspx";
        //编辑页面名称
        public const string EditName = "user_edit.aspx";
        ...
        private void RptBind(string _strWhere, string _orderby)
        {
            ...
            this.rptList.DataSource = db.GetPageList<t_user>(this.page, this.pageSize, _strWhere, _orderby, out this.totalCount);
        ...
        protected string CombSqlTxt(string _keywords)
        {
            ...
            {
                strTemp.Append(" (UserCode like  '%" + _keywords + "%' OR UserName like '%" + _keywords + "%' OR RegionCode like '%" + _keywords + "%' OR Mobile like '%" + _keywords + "%')");
            }
        ...
        {
            int _pagesize;
            if (int.TryParse(Utils.GetCookie("ccphl_user_page_size"), out _pagesize))
            {
                if (_pagesize > 0)
                {
                    return _pagesize;
        ...
        protected void txtPageNum_TextChanged(object sender, EventArgs e)
        {
            ...
            if (int.TryParse(txtPageNum.Text.Trim(), out _pagesize))
            {
                if (_pagesize > 0)
                {
                    Utils.WriteCookie("ccphl_user_page_size", _pagesize.ToString(), 14400);
                }
            }
