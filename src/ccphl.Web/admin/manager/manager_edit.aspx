<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="manager_edit.aspx.cs" Inherits="ccphl.Web.admin.manager.manager_edit" ValidateRequest="false" %>
...
<dl>
    ...
    <dd>
      <div class="rule-multi-porp">
          <asp:CheckBoxList ID="ddlRoleId" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow"></asp:CheckBoxList>
      </div>
    </dd>
  </dl>
  <dl>
