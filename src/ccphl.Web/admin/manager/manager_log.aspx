<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="manager_log.aspx.cs" Inherits="ccphl.Web.admin.manager.manager_log" %>
...
<body class="mainbody">
    ...
    <asp:Repeater ID="rptList" runat="server">
        ...
        <ItemTemplate>
            <tr>
                <td align="center">
                    <a href="manager_log.aspx?keywords=<%# Eval("UserName") %>">
                        <%# Eval("UserName")%></a>
                </td>
                <td align="center">
                    <a href="manager_log.aspx?keywords=<%# Eval("OperateType") %>">
                        <%# Eval("OperateType")%></a>
                </td>
                <td>
                    <%# Eval("LogCotent")%>
