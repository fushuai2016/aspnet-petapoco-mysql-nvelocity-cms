	...
	public class Thumbnail
	{
        ...
        public static bool Compression(string sFile, string dFile)
        {
            ...
            try
            {
                ...
                g.Dispose();
                PropertyItem[] pt = iSource.PropertyItems;//保存图片附带信息
        ...
        /// <param name="sFile">原图片</param>  
        /// <param name="dFile">压缩后保存位置</param> 
        /// <param name="widthShare">宽占比 4:3 值为4</param>
        /// <param name="heightShare">高占比 4:3 值为3</param>
        /// <param name="cutType">裁剪类型 0 填充 1 剪切</param>   
        /// <returns></returns>  
