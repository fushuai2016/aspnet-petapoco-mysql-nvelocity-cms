...
namespace ccphl.Common
{
    public class DTKeys
    {
        ...
        /// 系统配置文件名
        /// </summary>
        public const string FILE_SYSTEM_XML_CONFING = "Systempath";
        /// <summary>
        /// 图片配置文件名
        /// </summary>
        public const string FILE_IMG_XML_CONFING = "Imgpath";
        /// <summary>
        /// 升级代码
        /// </summary>
        ...
        /// 图片配置
        /// </summary>
        public const string CACHE_IMG_CONFIG = "dt_cache_img_config";
        /// <summary>
        /// 系统配置
        /// </summary>
        public const string CACHE_SYSTEM_CONFIG = "dt_cache_system_config";
        /// <summary>
        /// 站点配置
        /// </summary>
